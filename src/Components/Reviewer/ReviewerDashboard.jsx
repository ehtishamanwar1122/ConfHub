...
const renderAssigned = () =>
  assignedPapers.length ? (
    ...
    <p className="text-gray-600 text-sm mt-4">No assigned papers found.</p>
  );
...
const renderCompleted = () =>
  completedReviews.length ? (
    ...
    <p className="text-gray-600 text-sm mt-4">No completed reviews yet.</p>
  );
  ...
  return (
   <Layout>
      <div className="p-6">
        ...
        <div className="flex mb-6 p-2 rounded-full gap-4">
          {["papers", "completed"].map((tab) => (
            <button
              key={tab}
            ...
            >
              {tab === "papers" ? "Assigned Papers" : "Completed Reviews"}
            </button>
          ))}
        </div>
